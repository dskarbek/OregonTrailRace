...
The possible actions are:
   * Scout the road ahead -- draw a trail card (no hand limit)
   * Forge a new trail -- play a trail card or attempt to ford a river (you have to ford the rivers, but you pick someone else to suffer the calamities)
   * Mend a calamity -- play a supply card (or two if needed to mend one calamity)
   * Move backwards along your trail by one card (flip the card over)
   * Move forwards along your already forged trail by one card (flip the card back over, don't redo rivers or calamities, just flip back over)
   * Use a fort or town, either one that you are at, or putting one in your hand where you are.
...
That's the basics of the game.  Following are more details on how each part works.
...
The best way to do this is to trim the trail laid before a town or fort once all players have passed it.
...
Also, you can't travel backwards along your trail more than 4 steps, so you can pick up trail cards beyond that.
...
The river cards say on them how they must be forded.  It's always "roll an even number to successfully ford the river."
Most cards say that if you roll an odd number you lose a supply (pick one to put back in the bank).
Some river cards don't cost you supplies, but can cause your people to drown.  For these, if you roll a one then you lose a wagon member.
On 3 and 5 there is simply no negative effect other than still being stuck in the river.
If a wagon member drowns in the river then it is on your next turn that you have one fewer action, you don't lose an action on your current turn, because it was that attempt to ford the river that is the lost action.

When you play a trail card that causes a calamity, you pick which player will receive the calamity and then draw it.
See the [calamity details] for specifics on the play of each calamity.
It is basically what is printed on the card, but realize that "one round of play" means "one turn" of however many or few actions you have.
You can always remove any calamity from in front of you by choosing that option when using a town.

The thief calamity allows the person playing the calamity to randomly choose a supply card from the player they had choosen for the calamity (note that you choose the victim before finding out what the calamity is).
But, if the victim of thieving has bullets, they can discard those and turn the direction of thieving around.

The descriptions on the calamity cards are not always completely clear, especially in the context of these alternate rules, so refer to the [calamity details] for more info.

# Forts and Towns

When your last played trail card (or last face up one in the case of moving backwards) is right before a fort or town you can use the behavior listed on the card as an action.
If you have a fort or town card in your hand, you can place it on your tail at any point to use it.  You place and use the behavior as a single action.
When a fort or town is placed, it is placed perpendicular to the trails and in the middle of all of them.  It can be used by all players at that point in their trail.

You do not have to use a town or fort when you are passing by it.
If someone else has played it ahead of your trail, when your trail reaches it you can use an action to use the town / fort, or just keep forging your trail.
Either way, your trails do not have to match up on either side of the town / fort.
...
But, multiple calamities do need one action each to mend.
...
If you roll an even number then the trade is successful and the calamity is mended.
...
But, your action is not spent. You can attempt to trade again (as long as you have supplies to trade) or take a different action instead.
...
But, if you are low on wagon members, you may be in a situation where you are doomed.
You need an action to "use the town" or an action to "use the fort" and then a second action to "mend the calamity".
So, if you are more than 2 segments past the fort or 3 segments past a town, you won't have enough actions to save yourself.
Moral of the story is don't get too far out on the trail without a good stock of supplies that you can use (or trade) to mend broken wagons and dead oxen.
If you have a town or fort in your hand, you can place and use it when you have a broken wagon or dead oxen; as long as you aren't stuck in a river.
